    ...
    <v-container grid-list-xl fluid>
      <v-layout row wrap>
        ...
        <v-flex lg8 sm12 xs12>
          <v-widget title="Anzahl der Schäden" content-bg="white">
        ...
        <v-flex lg4 sm12 xs12>
          <v-widget title="Mitarbeiter Verteilung" content-bg="white">
            <div slot="widget-content">
                <e-chart 
                :path-option="[
        ...
        <v-flex lg8 sm12 xs12>
          ...
          <box-chart class="mt-4"
            card-color="pink"
            title="Verlauf der Schäden in den letzten 6 Monaten"
            sub-title="10%"
            icon="trending_up"
